import{html,Polymer}from"@polymer/polymer/polymer-legacy.js";import{dom}from"@polymer/polymer/lib/legacy/polymer.dom.js";import"@polymer/app-layout/app-toolbar/app-toolbar.js";import"@polymer/paper-input/paper-textarea.js";import"@polymer/paper-input/paper-input.js";import"@polymer/paper-checkbox/paper-checkbox.js";import"@polymer/paper-slider/paper-slider.js";import"@polymer/paper-tooltip/paper-tooltip.js";import"./simple-colors-picker.js";import"./hax-context-item-menu.js";import"./hax-context-item.js";Polymer({_template:html`
  ...
  `,is:"hax-input-mixer",listeners:{"hax-context-item-selected":"_haxContextOperation"},properties:{value:{type:String,value:null},label:{type:String,reflectToAttribute:!0},validation:{type:String,reflectToAttribute:!0},validationType:{type:String,reflectToAttribute:!0},required:{type:Boolean,reflectToAttribute:!0},options:{type:Object,value:{},reflectToAttribute:!0},icon:{type:String,value:"android",reflectToAttribute:!0},description:{type:String,reflectToAttribute:!0},inputMethod:{type:String,value:null,reflectToAttribute:!0,observer:"_inputMethodChanged"},propertyToBind:{type:String,reflectToAttribute:!0},slotToBind:{type:String,reflectToAttribute:!0}},ready:function(){this._resetInputMethods()},_inputMethodChanged:function(a,b){if(null!=a&&typeof b!==typeof void 0){let c=a,d=this.validInputMethods();if(d.includes(c)){this._resetInputMethods(),this["__input"+c]=!0;let f=dom(this);for(;null!==f.firstChild;)f.removeChild(f.firstChild);if("select"===c&&typeof this.options!==typeof void 0)for(val in this.options)item=document.createElement("paper-item"),item.attributes.value=val,item.innerHTML=this.options[val],f.appendChild(item);setTimeout(()=>{"function"===typeof this.shadowRoot.querySelector("#input").hideMenu&&this.shadowRoot.querySelector("#input").hideMenu(),this.shadowRoot.querySelector("#input").focus()},200)}}},validInputMethods:function(){return["flipboolean","boolean","select","confirm","textfield","textarea","datepicker","colorpicker","number"]},_resetInputMethods:function(){let a=this.validInputMethods();for(var b=0;b<a.length;b++)this["__input"+a[b]]=!1},_haxContextOperation:function(a){let b=a.detail;switch(b.eventName){case"hax-update-tap":if("boolean"==this.inputMethod)this.value=this.value;else if("flipboolean"==this.inputMethod)this.value=!this.value;else if("select"==this.inputMethod){var c=0;for(val in this.options){if(c==this.value){this.value=val;continue}c++}}let d={value:this.value,propertyToBind:this.propertyToBind,slotToBind:this.slotToBind};this.fire("hax-input-mixer-update",{inputMixer:d});}}});