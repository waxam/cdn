import{html,Polymer}from"@polymer/polymer/polymer-legacy.js";import"@polymer/iron-ajax/iron-ajax.js";import"@polymer/paper-button/paper-button.js";import"@polymer/paper-spinner/paper-spinner.js";import"@polymer/iron-icons/iron-icons.js";import"@polymer/iron-icon/iron-icon.js";import"@polymer/paper-tooltip/paper-tooltip.js";import"@lrnwebcomponents/materializecss-styles/materializecss-styles.js";let CsvRender=Polymer({_template:html`
  ...
  `,is:"csv-render",properties:{dataSource:{type:String},caption:{type:String,reflectToAttribute:!0},summary:{type:String,reflectToAttribute:!0},table:{type:Array,value:[]},tableHeadings:{type:Array,value:[]},tableData:{type:String,value:""}},handleResponse:function(){this.table=this.CSVtoArray(this.tableData),this.tableHeadings=this.table.shift(),this.$.loading.active=!1},CSVtoArray:function(a){let j,b="",c=[""],d=[c],f=0,g=0,h=!0;for(j in a)j=a[j],"\""===j?(h&&j===b&&(c[f]+=j),h=!h):","===j&&h?j=c[++f]="":"\n"===j&&h?("\r"===b&&(c[f]=c[f].slice(0,-1)),c=d[++g]=[j=""],f=0):c[f]+=j,b=j;return d}});export{CsvRender};