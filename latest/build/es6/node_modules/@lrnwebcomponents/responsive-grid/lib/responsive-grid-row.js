import{html,Polymer}from"@polymer/polymer/polymer-legacy.js";import"@lrnwebcomponents/responsive-utility/responsive-utility.js";import"./responsive-grid-col.js";import"./responsive-grid-clear.js";Polymer({_template:html`
    <style>
      :host {
        display: block;
        width: 100%;
  ...
  `,is:"responsive-grid-row",properties:{sm:{type:Number,value:null},md:{type:Number,value:null},lg:{type:Number,value:null},xl:{type:Number,value:null},gutter:{type:Number,value:0},responsiveToParent:{type:Boolean,value:!1,reflectToAttribute:!0},screen:{type:String,value:"xs",notify:!0,reflectToAttribute:!0}},attached:function(){let a=this;window.ResponsiveUtility.requestAvailability(),a.fire("responsive-element",{element:a,attribute:"screen",relativeToParent:a.responsiveToParent})}});