import{html,Polymer}from"./node_modules/@polymer/polymer/polymer-legacy.js";import{dom}from"./node_modules/@polymer/polymer/lib/legacy/polymer.dom.js";import"./node_modules/@polymer/iron-ajax/iron-ajax.js";import"./node_modules/@polymer/iron-list/iron-list.js";import"./node_modules/@polymer/paper-button/paper-button.js";import"./node_modules/@lrnwebcomponents/elmsln-loading/elmsln-loading.js";import"./lib/site-card.js";let SitesListing=Polymer({_template:html`
  ...
  `,is:"sites-listing",properties:{sites:{type:Array},size:{type:String,value:"large"},dataSource:{type:String}},_siteClicked:function(a){var b=dom(a),c=b.localTarget,d=c.getAttribute("data-site-id");let f=this.sites.filter(g=>{return!(g.id!==d)});0<f.length&&(f=f.pop()),typeof f.location!=="undefined"&&(window.location.href=f.location)},_mouseEnter:function(a){let b=dom(a.target).querySelectorAll("site-card")[0];b.__oldElevation=b.elevation,5<b.elevation+2?b.elevation=5:b.elevation+=2},_mouseLeave:function(a){let b=dom(a.target).querySelectorAll("site-card")[0];b.elevation=b.__oldElevation}});export{SitesListing};