import{html,Polymer}from"@polymer/polymer/polymer-legacy.js";import"@polymer/app-layout/app-toolbar/app-toolbar.js";import"./lrnsys-dialog-toolbar-button.js";Polymer({_template:html`
  ...
  `,is:"lrnsys-dialog-toolbar",listeners:{"dialog-toolbar-button-tapped":"_tapHandler"},properties:{_secondaryHasChildren:{type:Boolean,value:!1}},_tapHandler:function(a){this.fire("button-clicked",a.detail)},ready:function(){this.$.secondary.addEventListener("button-initialized",()=>{this._secondaryHasChildren=!0})}});