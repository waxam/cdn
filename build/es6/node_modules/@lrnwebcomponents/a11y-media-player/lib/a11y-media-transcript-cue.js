import{html,Polymer}from"../../../@polymer/polymer/polymer-legacy.js";import"../../../@polymer/iron-a11y-keys/iron-a11y-keys.js";import"../../simple-search/lib/simple-search-content.js";Polymer({_template:html`
  ...
  `,is:"a11y-media-transcript-cue",listeners:{tap:"_onClick"},behaviors:[a11yMediaBehaviors.TranscriptBehaviors],properties:{active:{type:Boolean,reflectToAttribute:!0,computed:"_getActiveCue(cue,activeCues)",notify:!0,reflectToAttribute:!0},activeCues:{type:Array,value:null,notify:!0},cue:{type:Array,value:null},disabled:{type:Boolean,value:!1},text:{type:String,value:""}},ready:function(){let root=this,search=root.search;if(!root.disabled){root.__target=this;root.setAttribute("aria-role","button");root.setAttribute("controls",this.mediaId)}if(!root.disableSearch&&root.search!==void 0&&null!==root.search){root.$.content.enableSearch(search)}},print:function(){},_getActiveCue:function(cue,activeCues){return null!==activeCues&&activeCues.includes(cue.order.toString())?!0:!1},_onClick:function(){if(!this.disabled){this.fire("cue-seek",this)}}});