import{html,Polymer}from"@polymer/polymer/polymer-legacy.js";import"@polymer/iron-a11y-keys/iron-a11y-keys.js";import"@lrnwebcomponents/simple-search/lib/simple-search-content.js";Polymer({_template:html`
  ...
  `,is:"a11y-media-transcript-cue",listeners:{tap:"_onClick"},behaviors:[a11yMediaBehaviors.TranscriptBehaviors],properties:{active:{type:Boolean,reflectToAttribute:!0,computed:"_getActiveCue(cue,activeCues)",notify:!0,reflectToAttribute:!0},activeCues:{type:Array,value:null,notify:!0},cue:{type:Array,value:null},disabled:{type:Boolean,value:!1},text:{type:String,value:""}},ready:function(){let a=this,b=a.search;a.disabled||(a.__target=this,a.setAttribute("aria-role","button"),a.setAttribute("controls",this.mediaId)),a.disableSearch||a.search===void 0||null===a.search||a.$.content.enableSearch(b)},print:function(){},_getActiveCue:function(a,b){return null!==b&&b.includes(a.order.toString())},_onClick:function(){this.disabled||this.fire("cue-seek",this)}});