import{html,Polymer}from"../../../@polymer/polymer/polymer-legacy.js";import"../../../@polymer/paper-slider/paper-slider.js";import"../../../@polymer/paper-listbox/paper-listbox.js";import"../../../@polymer/paper-item/paper-item.js";import"../../../@polymer/paper-tooltip/paper-tooltip.js";import"../../../@polymer/paper-menu-button/paper-menu-button.js";import"../../../@polymer/paper-toggle-button/paper-toggle-button.js";import"../../dropdown-select/dropdown-select.js";import"./a11y-media-behaviors.js";import"./a11y-media-button.js";Polymer({_template:html`
  ...
  `,is:"a11y-media-controls",behaviors:[a11yMediaBehaviors.MediaProps,a11yMediaBehaviors.GeneralFunctions,a11yMediaBehaviors.PlayerBehaviors],listeners:{"button-clicked":"_onButtonClick",change:"_onSettingsChanged"},properties:{playPause:{type:Object,computed:"_getPlayPause(playing,pauseLabel,pauseIcon,playLabel,playIcon)"},muteUnmute:{type:Object,computed:"_getMuteUnmute(muted,muteLabel,muteIcon,unmuteLabel,unmuteIcon)"}},attached:function(){let root=this;root._addResponsiveUtility({element:root,attribute:"responsive-size",relativeToParent:!0,sm:300,md:600,lg:900,xl:1200})},ready:function(){let root=this;root.$.tracks.addEventListener("change",function(e){if(null!==root.__selectedTrack){if(""!==e.detail.value){root.fire("select-track",{control:this,value:e.detail.value});root.fire("toggle-cc",{control:this,value:!0})}else{root.fire("toggle-cc",{control:this,value:!1})}}});root.$.settings.addEventListener("iron-activate",e=>{if(e.target==root.$.settingslist)e.preventDefault()});root.$.settings.addEventListener("iron-select",e=>{e.preventDefault()});root.$.mute.$.button.onfocus=function(){root.$.volume.classList.add("focus")};root.$.mute.$.button.onblur=function(){root.$.volume.classList.remove("focus")}},setStatus:function(time){this.$.statbar.innerText=time;this.$.statmenu.innerText=time},setTracks:function(tracks){this.set("tracks",[]);this.set("tracks",tracks.slice(0))},_getPlayPause:function(playing,pauseLabel,pauseIcon,playLabel,playIcon){return playing?{label:pauseLabel,icon:pauseIcon}:{label:playLabel,icon:playIcon}},_getMuteUnmute:function(muted,muteLabel,muteIcon,unmuteLabel,unmuteIcon){return muted?{label:unmuteLabel,icon:unmuteIcon}:{label:muteLabel,icon:muteIcon}},_onButtonClick:function(e){this.fire("controls-change",e.detail)},_onSettingsChanged:function(e){this.fire("controls-change",e.target)}});