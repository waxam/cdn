import{html,Polymer}from"../../../@polymer/polymer/polymer-legacy.js";import"../../simple-search/simple-search.js";import"./a11y-media-behaviors.js";import"./a11y-media-button.js";Polymer({_template:html`
  ...
  `,is:"a11y-media-transcript-controls",behaviors:[a11yMediaBehaviors.GeneralFunctions,a11yMediaBehaviors.TranscriptBehaviors],properties:{lang:{type:String,value:"en",reflectToAttribute:!0},target:{type:Object,value:null}},attached:function(){let root=this;root.search=root.$.search;root.fire("searchbar-added",root.$.search);root.$.scroll.addEventListener("button-clicked",function(){this.fire("toggle-scroll",this)});root.$.print.addEventListener("button-clicked",function(){this.fire("print-transcript",this)})}});