...
if(babelHelpers.typeof(oldValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&newValue!==oldValue){this.dispatchEvent(new CustomEvent("node-status-change",{bubbles:!0,cancelable:!0,composed:!0,detail:{status:newValue}}))}}/**
   ...
   */},{key:"_disableStatus",value:function _disableStatus(status){if("disabled"==status){return!0}return!1}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_fefc51807f5411e9b1675b5e716153d2())}},{key:"tag",get:function get(){return"lrnsys-progress-circle"}},{key:"properties",get:function get(){return{/**
       * Current value.
