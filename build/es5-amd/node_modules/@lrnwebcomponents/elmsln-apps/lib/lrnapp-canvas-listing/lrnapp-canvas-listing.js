define(["exports", "../../../../lit-element/lit-element.js", "../../../../@vaadin/vaadin-grid/vaadin-grid.js", "../../../../@vaadin/vaadin-grid/vaadin-grid-column-group.js", "../../../../@vaadin/vaadin-grid/vaadin-grid-filter.js", "../../../../@vaadin/vaadin-grid/vaadin-grid-sorter.js", "../../../../@vaadin/vaadin-grid/vaadin-grid-selection-column.js", "../../../../@polymer/iron-ajax/iron-ajax.js", "../../../../@polymer/iron-image/iron-image.js", "../../../../@polymer/paper-tooltip/paper-tooltip.js", "../../../lrnsys-layout/lib/lrnsys-dialog.js", "../../../elmsln-loading/elmsln-loading.js", "../../../lrndesign-avatar/lrndesign-avatar.js"], function (_exports, _litElement, _vaadinGrid, _vaadinGridColumnGroup, _vaadinGridFilter, _vaadinGridSorter, _vaadinGridSelectionColumn, _ironAjax, _ironImage, _paperTooltip, _lrnsysDialog, _elmslnLoading, _lrndesignAvatar) {
  ...
  function _templateObject8_73b04970234511eaa816efb437265b94() {
    ...
    _templateObject8_73b04970234511eaa816efb437265b94 = function _templateObject8_73b04970234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject7_73b04970234511eaa816efb437265b94() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <div class=\"avatar-name\" id=\"user-", "\">\n                    <lrndesign-avatar\n                      label=\"", "\"\n                      src=\"", "\"\n                    ></lrndesign-avatar>\n                  </div>\n                  <paper-tooltip for=\"user-", "\"\n                    >", "</paper-tooltip\n                  >\n                "]);

    _templateObject7_73b04970234511eaa816efb437265b94 = function _templateObject7_73b04970234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject6_73b04970234511eaa816efb437265b94() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <h2>", "s</h2>\n              ", "\n            "]);

    _templateObject6_73b04970234511eaa816efb437265b94 = function _templateObject6_73b04970234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject5_73b04970234511eaa816efb437265b94() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                      <iron-image\n                        style=\"width:100%; height:200px; background-color: lightgray;\"\n                        sizing=\"cover\"\n                        preload\n                        fade\n                        src=\"", "\"\n                      ></iron-image>\n                    "]);

    _templateObject5_73b04970234511eaa816efb437265b94 = function _templateObject5_73b04970234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject4_73b04970234511eaa816efb437265b94() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                ", "\n                <span class=\"heading\">\n                  <span>Student count: ", "</span>\n                  <span>SIS ID: ", "</span>\n                  <span>Term: ", "</span>\n                  <span>Workflow: ", "</span>\n                </span>\n              "]);

    _templateObject4_73b04970234511eaa816efb437265b94 = function _templateObject4_73b04970234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject3_73b04970234511eaa816efb437265b94() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <div id=\"loadingRoster\" class=\"loading\">\n                  <h3>Loading..</h3>\n                  <elmsln-loading\n                    color=\"grey-text\"\n                    size=\"large\"\n                  ></elmsln-loading>\n                </div>\n              "]);

    _templateObject3_73b04970234511eaa816efb437265b94 = function _templateObject3_73b04970234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject2_73b04970234511eaa816efb437265b94() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <option value=\"", "\">\n                    ", " (", ")\n                  </option>\n                "]);

    _templateObject2_73b04970234511eaa816efb437265b94 = function _templateObject2_73b04970234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject_73b04970234511eaa816efb437265b94() {
    ...
    _templateObject_73b04970234511eaa816efb437265b94 = function _templateObject_73b04970234511eaa816efb437265b94() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(LrnappCanvasListing, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_73b04970234511eaa816efb437265b94(), this.sourcePath, this.handleResponse, this.queryResponseEvent, this._toArray(this.canvasCourses), this._filterTerm, this._filterTermEvent, this._filterCourse, this._filterCourseEvent, this._filterSIS, this._filterSISChanged, this._filterWorkflow, this._filterWorkflowChanged, this.elmslnCourses.map(function (elmsCourse) {
          return (0, _litElement.html)(_templateObject2_73b04970234511eaa816efb437265b94(), elmsCourse.machineName, elmsCourse.name, elmsCourse.machineName);
        }), this._filterELMSLNCourse, this.filterELMSLNCourseEvent, this._triggerDialog, this.sourcePath, this.handleRosterResponse, this.queryResponseRosterEvent, this.activeCourse.name, !this.roster ? (0, _litElement.html)(_templateObject3_73b04970234511eaa816efb437265b94()) : "", this.roster ? (0, _litElement.html)(_templateObject4_73b04970234511eaa816efb437265b94(), this.activeCourse.image ? (0, _litElement.html)(_templateObject5_73b04970234511eaa816efb437265b94(), this.activeCourse.image) : "", this.activeCourse.student_count, this.activeCourse.sis_course_id, this.activeCourse.term, this.activeCourse.workflow_state) : "", this._toArray(this.roster).map(function (roleList) {
          return (0, _litElement.html)(_templateObject6_73b04970234511eaa816efb437265b94(), roleList.role, _this2._toArray(roleList.users).map(function (user) {
            return (0, _litElement.html)(_templateObject7_73b04970234511eaa816efb437265b94(), user.id, user.name, user.picture, user.id, user.name);
          }));
        }));
      }
    }, {
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject8_73b04970234511eaa816efb437265b94())];
      }
    }, {
      key: "tag",
      get: function get() {
