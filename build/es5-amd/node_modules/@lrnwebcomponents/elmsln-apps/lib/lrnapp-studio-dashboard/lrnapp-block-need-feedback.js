define(["exports", "../../../../lit-element/lit-element.js", "../../../../@polymer/iron-ajax/iron-ajax.js", "../../../../@polymer/paper-button/paper-button.js", "../../../hexagon-loader/hexagon-loader.js", "../../../lrndesign-gallerycard/lrndesign-gallerycard.js"], function (_exports, _litElement, _ironAjax, _paperButton, _hexagonLoader, _lrndesignGallerycard) {
  ...
  function _templateObject3_740df9d0234511eaa816efb437265b94() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        paper-button {\n          width: 100%;\n        }\n      "]);

    _templateObject3_740df9d0234511eaa816efb437265b94 = function _templateObject3_740df9d0234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject2_740df9d0234511eaa816efb437265b94() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <paper-button @click=\"", "\">\n            <lrndesign-gallerycard\n              data-submission-id=\"", "\"\n              title=\"", "\"\n              author=\"", "\"\n              comments=\"", "\"\n              image=\"", "\"\n              icon=\"", "\"\n              class=\"ferpa-protect\"\n            >\n            </lrndesign-gallerycard>\n          </paper-button>\n        "]);

    _templateObject2_740df9d0234511eaa816efb437265b94 = function _templateObject2_740df9d0234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject_740df9d0234511eaa816efb437265b94() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <iron-ajax\n        auto=\"\"\n        url=\"", "\"\n        handle-as=\"json\"\n        @last-response-changed=\"", "\"\n        @response=\"", "\"\n      ></iron-ajax>\n      <hexagon-loader\n        id=\"loader\"\n        item-count=\"4\"\n        ?loading=", "\n        size=\"small\"\n      ></hexagon-loader>\n      ", "\n    "]);

    _templateObject_740df9d0234511eaa816efb437265b94 = function _templateObject_740df9d0234511eaa816efb437265b94() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(LrnappBlockNeedFeedback, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_740df9d0234511eaa816efb437265b94(), this.sourcePath, this.responseEvent, this.handleResponse, this.loading, this._toArray(this.response.data).map(function (item) {
          return (0, _litElement.html)(_templateObject2_740df9d0234511eaa816efb437265b94(), _this2._loadSubmissionUrl, item.id, item.attributes.title, item.relationships.author.data, item.meta.comment_count, item.display.image, item.display.icon);
        }));
      }
    }, {
      key: "responseEvent",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject3_740df9d0234511eaa816efb437265b94())];
      }
    }, {
      key: "tag",
      get: function get() {
