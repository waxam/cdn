define(["exports", "../../../../lit-element/lit-element.js", "../../../../@polymer/polymer/lib/elements/custom-style.js", "../../../../@polymer/paper-card/paper-card.js", "../../../materializecss-styles/materializecss-styles.js", "./lrnapp-block-recent-project.js", "./lrnapp-block-recent-submissions.js", "./lrnapp-block-recent-comments.js", "./lrnapp-block-need-feedback.js"], function (_exports, _litElement, _customStyle, _paperCard, _materializecssStyles, _lrnappBlockRecentProject, _lrnappBlockRecentSubmissions, _lrnappBlockRecentComments, _lrnappBlockNeedFeedback) {
  ...
  function _templateObject2_741e7490234511eaa816efb437265b94() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        h1.title {\n          font-size: 2em;\n          color: black;\n          margin: 0;\n          padding: 0.5em 0 0 0;\n          text-transform: none;\n          text-align: left;\n        }\n        p.para {\n          margin: 0;\n          padding: 0.25em 0.5em;\n        }\n        .dashboard-row {\n          width: 100%;\n          display: inline-flex;\n        }\n        .dashboard-item {\n          width: 30%;\n        }\n      "]);

    _templateObject2_741e7490234511eaa816efb437265b94 = function _templateObject2_741e7490234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject_741e7490234511eaa816efb437265b94() {
    ...
    _templateObject_741e7490234511eaa816efb437265b94 = function _templateObject_741e7490234511eaa816efb437265b94() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(LrnappStudioDashboard, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_741e7490234511eaa816efb437265b94(), this.username, this.csrfToken, this._getEndPoint(this.basePath), this.basePath, this._getDataSource(this.csrfToken, this.basePath, "recent-project"), this.csrfToken, this._getEndPoint(this.basePath), this.basePath, this._getDataSource(this.csrfToken, this.basePath, "need-feedback"), this.csrfToken, this._getEndPoint(this.basePath), this.basePath, this._getDataSource(this.csrfToken, this.basePath, "recent-submissions"), this.csrfToken, this._getEndPoint(this.basePath), this.basePath, this._getDataSource(this.csrfToken, this.basePath, "recent-comments"));
      }
    }, {
      key: "updated",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_741e7490234511eaa816efb437265b94())];
      }
    }, {
      key: "tag",
      get: function get() {
