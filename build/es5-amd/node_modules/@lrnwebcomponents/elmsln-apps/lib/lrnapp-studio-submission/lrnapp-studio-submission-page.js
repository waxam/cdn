define(["exports", "../../../../lit-element/lit-element.js", "../../../../@polymer/app-route/app-route.js", "../../../../@polymer/iron-ajax/iron-ajax.js", "../../../../@polymer/app-layout/app-toolbar/app-toolbar.js", "../../../../@polymer/marked-element/marked-element.js", "../../../../@polymer/iron-icon/iron-icon.js", "../../../../@polymer/paper-dialog/paper-dialog.js", "../../../../@polymer/paper-button/paper-button.js", "../../../../@polymer/paper-badge/paper-badge.js", "../../../../@polymer/paper-toast/paper-toast.js", "../../../../@vaadin/vaadin-split-layout/vaadin-split-layout.js", "../../../lrnsys-layout/lib/lrnsys-dialog.js", "../../../lrnsys-button/lrnsys-button.js", "../../../lrnsys-comment/lib/lrnsys-comment-list.js", "../../../elmsln-loading/elmsln-loading.js", "./lrnapp-studio-submission-object.js", "./lrnapp-studio-submission-comments.js", "./lrnapp-studio-submission-comment.js", "../../../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _litElement, _appRoute, _ironAjax, _appToolbar, _markedElement, _ironIcon, _paperDialog, _paperButton, _paperBadge, _paperToast, _vaadinSplitLayout, _lrnsysDialog, _lrnsysButton, _lrnsysCommentList, _elmslnLoading, _lrnappStudioSubmissionObject, _lrnappStudioSubmissionComments, _lrnappStudioSubmissionComment, _customStyle) {
  ...
  function _templateObject5_7578ad60234511eaa816efb437265b94() {
    ...
    _templateObject5_7578ad60234511eaa816efb437265b94 = function _templateObject5_7578ad60234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject4_7578ad60234511eaa816efb437265b94() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <lrnsys-comment-list\n                  comment-ops-base=\"", "\"\n                  csrf-token=\"", "\"\n                  source-path=\"", "\"\n                  create-stub-url=\"", "\"\n                ></lrnsys-comment-list>\n              "]);

    _templateObject4_7578ad60234511eaa816efb437265b94 = function _templateObject4_7578ad60234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject3_7578ad60234511eaa816efb437265b94() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <lrnsys-button\n                @click=\"", "\"\n                icon=\"arrow-back\"\n                label=\"Back to project management\"\n                hover-class=\"amber darken-4 white-text\"\n              ></lrnsys-button>\n            "]);

    _templateObject3_7578ad60234511eaa816efb437265b94 = function _templateObject3_7578ad60234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject2_7578ad60234511eaa816efb437265b94() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <lrnsys-button\n                @click=\"", "\"\n                icon=\"arrow-back\"\n                label=\"See in studio\"\n                hover-class=\"amber darken-4 white-text\"\n              ></lrnsys-button>\n            "]);

    _templateObject2_7578ad60234511eaa816efb437265b94 = function _templateObject2_7578ad60234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject_7578ad60234511eaa816efb437265b94() {
    ...
    _templateObject_7578ad60234511eaa816efb437265b94 = function _templateObject_7578ad60234511eaa816efb437265b94() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(LrnappStudioSubmissionPage, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_7578ad60234511eaa816efb437265b94(), this.route, this.routeChangedEvent, this.tail, this.tailChangedEvent, this.editPage, this.editPageChangedEvent, this.reqUrl, this.reqParams, this._handleResponse, this.reqUrl, this.submission, this.reqParams, this._handleUpdateResponse, this.reqUrl, this.reqParams, this._handleDeleteResponse, this.hideMenuBar, this.showComments ? (0, _litElement.html)(_templateObject2_7578ad60234511eaa816efb437265b94(), this._backToStudio) : (0, _litElement.html)(_templateObject3_7578ad60234511eaa816efb437265b94(), this._backToKanban), this.submission.attributes.title, this.submission.relationships.assignment.attributes.title, this.submission.relationships.assignment.attributes.body, this.submission.meta.comment_count, this.displayNewBadge(this.submission.meta.comment_new), this.submission.meta.comment_new, this.editPage, this._setEditRoute, !this.submission.meta.canUpdate, !this.editPage, this._resetRoute, !this.submission.meta.canUpdate, this.showComments ? (0, _litElement.html)(_templateObject4_7578ad60234511eaa816efb437265b94(), this.commentOpsBase, this.csrfToken, this.commentsUrl, this.createStubUrl) : "", this.submission, this.editPage, this._submissionDeleteConfirmed, this._submissionPublishConfirmed);
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject5_7578ad60234511eaa816efb437265b94())];
      }
    }]);
