define(["exports","../../../../@polymer/polymer/polymer-element.js","../../../../@polymer/paper-card/paper-card.js","../../../../@polymer/marked-element/marked-element.js","../../../../@polymer/iron-image/iron-image.js","../../../../@polymer/polymer/lib/elements/dom-if.js","../../../image-inspector/image-inspector.js","../../../lrndesign-avatar/lrndesign-avatar.js","../../../word-count/word-count.js","../../../../@polymer/polymer/lib/elements/dom-repeat.js","../../../lrnsys-button/lrnsys-button.js","../../../lrndesign-contentblock/lrndesign-contentblock.js","../../../lrnsys-layout/lib/lrnsys-dialog.js"],function(_exports,_polymerElement,_paperCard,_markedElement,_ironImage,_domIf,_imageInspector,_lrndesignAvatar,_wordCount,_domRepeat,_lrnsysButton,_lrndesignContentblock,_lrnsysDialog){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.LrnappStudioSubmissionDisplay=void 0;function _templateObject_16387fe07f5511e9b1675b5e716153d2(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n        p {\n          font-size: 14px;\n          line-height: 18px;\n        }\n        h1,\n        h2,\n        h3 {\n          margin: 0;\n          text-align: left;\n        }\n        iron-selector {\n          line-height: 1em;\n        }\n        iron-selector lrnsys-button {\n          display: inline-flex;\n        }\n        marked-element {\n          display: block;\n          margin: 0 5em 0 5em;\n        }\n        iron-image {\n          margin: 0 0.5em;\n        }\n        lrnsys-dialog {\n          display: inline;\n        }\n        .contain {\n          width: 10em;\n          height: 10em;\n          background: #ddd;\n        }\n        .center {\n          margin: auto;\n          width: 100%;\n        }\n        .title {\n          color: #222;\n          font-size: 2rem;\n          font-weight: 600;\n          line-height: 2.5rem;\n          padding: 0.25rem 0;\n          white-space: nowrap;\n          overflow-x: hidden;\n          text-overflow: ellipsis;\n          margin-top: 1rem;\n          text-align: center;\n        }\n        .author {\n          color: #555;\n          font-size: 1rem;\n          font-weight: 500;\n          font-style: normal;\n          line-height: 1rem;\n          padding: 0.25rem 0 0.5rem 0;\n          margin: 0;\n          text-transform: capitalize;\n        }\n        .date {\n          color: #555;\n          font-size: 16px;\n          font-style: normal;\n          padding: 0.25rem 0 0.5rem 0;\n          margin: 0;\n        }\n        .flex-wrap {\n          display: flex;\n        }\n        .submission-page-card {\n          width: 100%;\n          margin: 0;\n        }\n        :host([edit-page]) .submission-page {\n          width: 100%;\n        }\n        .image-dialog-header {\n          display: flex;\n        }\n        app-toolbar {\n          width: 36em;\n          background: #ddd;\n        }\n        lrnsys-button {\n          padding: 0.75em;\n        }\n        .top {\n          top: 8em;\n        }\n      </style>\n      <div class=\"submission-page\">\n        <paper-card class=\"submission-page-card ferpa-protect\">\n          <div class=\"card-content\">\n            <lrndesign-avatar\n              class=\"center\"\n              label=\"{{submission.relationships.author.data.name}}\"\n              src=\"{{submission.relationships.author.data.avatar}}\"\n            ></lrndesign-avatar>\n            <div class=\"author center\">\n              {{submission.relationships.author.data.display_name}}\n            </div>\n            <h2 class=\"title center\">{{submission.attributes.title}}</h2>\n            <div class=\"date center\">\n              Created: [[date(submission.meta.created)]]\n            </div>\n            <div class=\"date center\">\n              Last updated: [[date(submission.meta.changed)]]\n            </div>\n            <!-- ----- Text Submission ----- -->\n            <template is=\"dom-if\" if=\"[[submission.attributes.body]]\">\n              <word-count\n                ><marked-element\n                  markdown=\"[[submission.attributes.body]]\"\n                ></marked-element\n              ></word-count>\n            </template>\n            <!-- ----- Images Submission ----- -->\n            <template is=\"dom-if\" if=\"[[submission.attributes.images]]\">\n              <lrndesign-contentblock class=\"center\">\n                <template\n                  is=\"dom-repeat\"\n                  items=\"[[_toArray(submission.attributes.images)]]\"\n                  as=\"image\"\n                >\n                  <lrnsys-dialog alt=\"View Image\" dynamic-images=\"\">\n                    <div class=\"image-dialog-header\"></div>\n                    <span slot=\"button\">\n                      <iron-image\n                        style=\"width:200px; height:200px; background-color: lightgray;\"\n                        sizing=\"contain\"\n                        class=\"contain\"\n                        src=\"[[image.thumbnail]]\"\n                        preload=\"\"\n                        fade=\"\"\n                      ></iron-image>\n                    </span>\n                    <div style=\"text-align: center;\">\n                      <template is=\"dom-if\" if=\"[[!_isGif(image.url)]]\">\n                        <image-inspector src=\"[[image.url]]\">\n                          <span slot=\"toolbar\">\n                            <lrnsys-button\n                              alt=\"Download all images\"\n                              icon=\"icons:file-download\"\n                              href=\"[[submission.attributes.download_files]]\"\n                              target=\"_blank\"\n                            ></lrnsys-button>\n                          </span>\n                        </image-inspector>\n                      </template>\n                      <template is=\"dom-if\" if=\"[[_isGif(image.url)]]\">\n                        <iron-image\n                          style=\"width:500px; height:500px; background-color: lightgray;\"\n                          sizing=\"contain\"\n                          class=\"contain\"\n                          src=\"[[image.url]]\"\n                          preload=\"\"\n                          fade=\"\"\n                        ></iron-image>\n                      </template>\n                    </div>\n                  </lrnsys-dialog>\n                </template>\n              </lrndesign-contentblock>\n            </template>\n            <!-- ----- Video Submission ----- -->\n            <template is=\"dom-if\" if=\"[[submission.attributes.video]]\">\n              <lrndesign-contentblock class=\"center\">\n                <template\n                  is=\"dom-repeat\"\n                  items=\"[[_toArray(submission.attributes.video)]]\"\n                  as=\"video\"\n                >\n                  <iframe\n                    width=\"460\"\n                    height=\"249\"\n                    src=\"[[video.video_src]]\"\n                  ></iframe>\n                </template>\n              </lrndesign-contentblock>\n            </template>\n            <!-- ----- Links Submission ----- -->\n            <template is=\"dom-if\" if=\"[[submission.attributes.links]]\">\n              <lrndesign-contentblock>\n                <template\n                  is=\"dom-repeat\"\n                  items=\"[[_toArray(submission.attributes.links)]]\"\n                  as=\"link\"\n                >\n                  <p>\n                    <strong>[[link.title]]:</strong>\n                    <a class=\"link\" href=\"[[link.url]]\" target=\"_blank\"\n                      >[[link.url]]</a\n                    >\n                  </p>\n                </template>\n              </lrndesign-contentblock>\n            </template>\n            <!-- ----- Files Submission ----- -->\n            <template is=\"dom-if\" if=\"[[submission.attributes.files]]\">\n              <lrndesign-contentblock title=\"Files Submitted\">\n                <template\n                  is=\"dom-repeat\"\n                  items=\"[[_toArray(submission.attributes.files)]]\"\n                  as=\"file\"\n                >\n                  <p>\n                    <strong>[[file.filename]]:</strong>\n                    <a class=\"link\" href=\"[[file.url]]\" target=\"_blank\"\n                      >[[file.url]]</a\n                    >\n                  </p>\n                </template>\n              </lrndesign-contentblock>\n            </template>\n          </div>\n        </paper-card>\n      </div>\n    "]);_templateObject_16387fe07f5511e9b1675b5e716153d2=function _templateObject_16387fe07f5511e9b1675b5e716153d2(){return data};return data}var LrnappStudioSubmissionDisplay=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(LrnappStudioSubmissionDisplay,_PolymerElement);function LrnappStudioSubmissionDisplay(){babelHelpers.classCallCheck(this,LrnappStudioSubmissionDisplay);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(LrnappStudioSubmissionDisplay).apply(this,arguments))}babelHelpers.createClass(LrnappStudioSubmissionDisplay,[{key:"date",value:function date(time){if(time){var parts=time.split("-"),times=time.split("T"),month=parts[2].split("T");times=times[1].split("-");return parts[1]+"/"+month[0]+" - "+times[0]}}/**
   ...
   */},{key:"_isGif",value:function _isGif(url){if(-1!=url.indexOf(".gif")){return!0}return!1}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_16387fe07f5511e9b1675b5e716153d2())}},{key:"tag",get:function get(){return"lrnapp-studio-submission-display"}},{key:"properties",get:function get(){return{/**
