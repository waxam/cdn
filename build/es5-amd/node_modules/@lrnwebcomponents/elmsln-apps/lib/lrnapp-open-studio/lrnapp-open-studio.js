define(["exports", "../../../../lit-element/lit-element.js", "../../../../@polymer/iron-ajax/iron-ajax.js", "../../../../@polymer/iron-list/iron-list.js", "../../../../@polymer/iron-pages/iron-pages.js", "../../../../@polymer/iron-selector/iron-selector.js", "../../../../@polymer/app-layout/app-toolbar/app-toolbar.js", "../../../../@polymer/app-route/app-location.js", "../../../../@polymer/app-route/app-route.js", "../../../../@polymer/paper-dropdown-menu/paper-dropdown-menu.js", "../../../../@polymer/paper-listbox/paper-listbox.js", "../../../../@polymer/paper-item/paper-item.js", "../../../../@polymer/paper-toast/paper-toast.js", "../../../lrndesign-gallerycard/lrndesign-gallerycard.js", "../../../elmsln-loading/elmsln-loading.js", "./lrnapp-open-studio-table.js", "./lrnapp-open-studio-projects.js", "./lrnapp-open-studio-assignments.js"], function (_exports, _litElement, _ironAjax, _ironList, _ironPages, _ironSelector, _appToolbar, _appLocation, _appRoute, _paperDropdownMenu, _paperListbox, _paperItem, _paperToast, _lrndesignGallerycard, _elmslnLoading, _lrnappOpenStudioTable, _lrnappOpenStudioProjects, _lrnappOpenStudioAssignments) {
  ...
  function _templateObject5_7409db20234511eaa816efb437265b94() {
    ...
    _templateObject5_7409db20234511eaa816efb437265b94 = function _templateObject5_7409db20234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject4_7409db20234511eaa816efb437265b94() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <paper-item item-id=\"", "\"\n                  >", "</paper-item\n                >\n              "]);

    _templateObject4_7409db20234511eaa816efb437265b94 = function _templateObject4_7409db20234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject3_7409db20234511eaa816efb437265b94() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <paper-item item-id=\"", "\"\n                  >", "</paper-item\n                >\n              "]);

    _templateObject3_7409db20234511eaa816efb437265b94 = function _templateObject3_7409db20234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject2_7409db20234511eaa816efb437265b94() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <paper-item item-id=\"", "\"\n                  >", "</paper-item\n                >\n              "]);

    _templateObject2_7409db20234511eaa816efb437265b94 = function _templateObject2_7409db20234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject_7409db20234511eaa816efb437265b94() {
    ...
    _templateObject_7409db20234511eaa816efb437265b94 = function _templateObject_7409db20234511eaa816efb437265b94() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(LrnappOpenStudio, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_7409db20234511eaa816efb437265b94(), this.sourcePath, this.studioResponseChangedEvent, this._handleResponse, this.route, this.routeChangedEvent, this.queryParams, this.queryParamsChangedEvent, this.route, this.routeChangedEvent, this.data, this.dataChangedEvent, this.tail, this.tailChangedEvent, this.queryParams, this.queryParamsChangedEvent, this.endPoint, this.data.page, this.dataPageChangedEvent, this._submissionsClicked, this._projectsClicked, this._assignmentsClicked, this._tableClicked, this.submissions.length, this.originalSubmissions.length, !this.authors, this.queryParams.author, this.queryParamsAuthorEvent, this._toArray(this.authors).map(function (author) {
          return (0, _litElement.html)(_templateObject2_7409db20234511eaa816efb437265b94(), author.id, author.display_name);
        }), !this.projects, this.queryParams.project, this.queryParamsProjectEvent, this._toArray(this.projects).map(function (project) {
          return (0, _litElement.html)(_templateObject3_7409db20234511eaa816efb437265b94(), project.id, project.attributes.title);
          ...
          return (0, _litElement.html)(_templateObject4_7409db20234511eaa816efb437265b94(), assignment.id, assignment.attributes.title);
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject5_7409db20234511eaa816efb437265b94())];
      }
    }, {
      key: "tag",
      get: function get() {
