define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../../@polymer/polymer/lib/elements/dom-if.js"],function(_exports,_require,_polymerElement,_renderStatus,_domIf){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.PdfBrowserViewer=void 0;_require=babelHelpers.interopRequireWildcard(_require);function _templateObject_cc7300607f5411e9b1675b5e716153d2(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: none;\n        }\n        :host([file]) {\n          display: inherit;\n        }\n      </style>\n\n      <template is=\"dom-if\" if=\"[[card]]\">\n        <paper-card heading=\"[[heading]]\" elevation=\"[[elevation]]\">\n          <div class=\"card-content\">\n            <object\n              data=\"[[file]]\"\n              type=\"application/pdf\"\n              width=\"[[width]]\"\n              height=\"[[height]]\"\n            >\n              <p>\n                {{notSupportedMessage}}\n                <a href=\"[[file]]\">{{notSupportedLinkMessage}}</a>\n              </p>\n            </object>\n          </div>\n          <div class=\"card-actions\">\n            <paper-button on-click=\"_download\">[[downloadLabel]]</paper-button>\n          </div>\n        </paper-card>\n      </template>\n\n      <template is=\"dom-if\" if=\"[[!card]]\">\n        <object\n          data=\"[[file]]\"\n          type=\"application/pdf\"\n          width=\"[[width]]\"\n          height=\"[[height]]\"\n        >\n          <p>\n            {{notSupportedMessage}}\n            <a href=\"[[file]]\">{{notSupportedLinkMessage}}</a>\n          </p>\n        </object>\n      </template>\n    "]);_templateObject_cc7300607f5411e9b1675b5e716153d2=function _templateObject_cc7300607f5411e9b1675b5e716153d2(){return data};return data}/**
@license
...
*/var PdfBrowserViewer=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(PdfBrowserViewer,_PolymerElement);function PdfBrowserViewer(){var _this;babelHelpers.classCallCheck(this,PdfBrowserViewer);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(PdfBrowserViewer).call(this));new Promise(function(res,rej){return _require.default(["../../@polymer/paper-card/paper-card.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../@polymer/paper-button/paper-button.js"],res,rej)});return _this}babelHelpers.createClass(PdfBrowserViewer,[{key:"clear",/**
   ...
   */},{key:"_download",value:function _download(){window.location=this.file}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_cc7300607f5411e9b1675b5e716153d2())}},{key:"tag",get:function get(){return"pdf-browser-viewer"}},{key:"properties",get:function get(){return{/**
