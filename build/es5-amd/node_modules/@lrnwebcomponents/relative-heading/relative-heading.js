define(["exports","../../@polymer/polymer/polymer-element.js","../hax-body-behaviors/lib/HAXWiring.js"],function(_exports,_polymerElement,_HAXWiring){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.RelativeHeading=void 0;function _templateObject_d11e87107f5411e9b1675b5e716153d2(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n        :host([hidden]) {\n          display: none;\n        }\n        :host h1,\n        :host h2,\n        :host h3,\n        :host h4,\n        :host h5,\n        :host h6 {\n          @apply --relative-heading-style;\n        }\n        :host h1 {\n          @apply --relative-heading-h1;\n        }\n        :host h2 {\n          @apply --relative-heading-h2;\n        }\n        :host h3 {\n          @apply --relative-heading-h3;\n        }\n        :host h4 {\n          @apply --relative-heading-h4;\n        }\n        :host h5 {\n          @apply --relative-heading-h5;\n        }\n        :host h6 {\n          @apply --relative-heading-h6;\n        }\n      </style>\n      <h1 aria-live=\"polite\" hidden=\"[[!__isLevel1]]\">[[text]]</h1>\n      <h2 aria-live=\"polite\" hidden=\"[[!__isLevel2]]\">[[text]]</h2>\n      <h3 aria-live=\"polite\" hidden=\"[[!__isLevel3]]\">[[text]]</h3>\n      <h4 aria-live=\"polite\" hidden=\"[[!__isLevel4]]\">[[text]]</h4>\n      <h5 aria-live=\"polite\" hidden=\"[[!__isLevel5]]\">[[text]]</h5>\n      <h6 aria-live=\"polite\" hidden=\"[[!__isLevel6]]\">[[text]]</h6>\n    "]);_templateObject_d11e87107f5411e9b1675b5e716153d2=function _templateObject_d11e87107f5411e9b1675b5e716153d2(){return data};return data}/**
 * `relative-heading`
...
get:function get(){return(0,_polymerElement.html)(_templateObject_d11e87107f5411e9b1675b5e716153d2())}// haxProperty definition
