...
*/var EditableTableEditor=/*#__PURE__*/function(_editBehaviors){babelHelpers.inherits(EditableTableEditor,_editBehaviors);function EditableTableEditor(){babelHelpers.classCallCheck(this,EditableTableEditor);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(EditableTableEditor).apply(this,arguments))}babelHelpers.createClass(EditableTableEditor,[{key:"ready",/**
   ...
   */},{key:"insertRow",value:function insertRow(index){for(var temp=[],i=0;i<this.data[0].length;i++){temp.push("")}this.splice("data",index+1,0,temp)}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_e8d4ee807f5411e9b1675b5e716153d2())}},{key:"tag",get:function get(){return"editable-table-editor"}},{key:"observers",get:function get(){return["_setMinimumData(data)"]}},{key:"properties",get:function get(){return{/**
