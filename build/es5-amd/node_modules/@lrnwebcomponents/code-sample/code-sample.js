define(["exports","../../@polymer/polymer/polymer-element.js","../hax-body-behaviors/lib/HAXWiring.js","../../@polymer/polymer/lib/utils/flattened-nodes-observer.js","./lib/themes/one-dark.js","./lib/highlightjs/highlight.js","./lib/highlightjs/languages/javascript.js","./lib/highlightjs/languages/xml.js"],function(_exports,_polymerElement,_HAXWiring,_flattenedNodesObserver,_oneDark,_highlight2,_javascript,_xml){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.CodeSample=void 0;function _templateObject_cad9c2c07f5411e9b1675b5e716153d2(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n\n        :host([hidden]),\n        [hidden] {\n          display: none;\n        }\n\n        pre {\n          margin: 0;\n          @apply --code-sample-pre;\n        }\n\n        pre,\n        code {\n          font-family: var(\n            --code-sample-font-family,\n            Operator Mono,\n            Inconsolata,\n            Roboto Mono,\n            monaco,\n            consolas,\n            monospace\n          );\n          font-size: var(--code-sample-font-size, 0.875rem);\n        }\n\n        .hljs {\n          padding: 0 1.25rem;\n          line-height: var(--code-sample-line-height, 1.3);\n          @apply --code-sample-hljs;\n        }\n\n        .demo:not(:empty) {\n          padding: var(--code-sample-demo-padding, 0 0 1.25rem);\n          @apply --code-sample-demo-not-empty;\n        }\n\n        .demo {\n          @apply --code-sample-demo;\n        }\n\n        #code-container {\n          position: relative;\n          @apply --code-sample-code-container;\n        }\n\n        #code-container:hover {\n          @apply --code-sample-code-container-hover;\n        }\n\n        #code-container:hover > button {\n          @apply --code-sample-code-container-hover-button;\n        }\n\n        button {\n          background: var(--code-sample-copy-button-bg-color, #e0e0e0);\n          border: none;\n          cursor: pointer;\n          display: block;\n          position: absolute;\n          right: 0;\n          top: 0;\n          text-transform: uppercase;\n          @apply --code-sample-copy-clipboard-button;\n        }\n      </style>\n      <div id=\"theme\">","</div>\n      <div id=\"demo\" class=\"demo\"></div>\n      <slot id=\"content\"></slot>\n\n      <div id=\"code-container\">\n        <button\n          type=\"button\"\n          hidden=\"[[!copyClipboardButton]]\"\n          id=\"copyButton\"\n          title=\"Copy to clipboard\"\n          on-click=\"_copyToClipboard\"\n        >\n          Copy\n        </button>\n        <pre id=\"code\"></pre>\n      </div>\n    "]);_templateObject_cad9c2c07f5411e9b1675b5e716153d2=function _templateObject_cad9c2c07f5411e9b1675b5e716153d2(){return data};return data}_highlight2.hljs.registerLanguage("javascript",_javascript.javascript);_highlight2.hljs.registerLanguage("xml",_xml.xml);window.hljs=_highlight2.hljs;/**
 * `code-sample`
...
get:function get(){return(0,_polymerElement.html)(_templateObject_cad9c2c07f5411e9b1675b5e716153d2(),this.constructor.theme||_oneDark.oneDark)}// haxProperty definition
