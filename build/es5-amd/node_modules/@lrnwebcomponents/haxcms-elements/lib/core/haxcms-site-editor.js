...
if(this.saveNodePath){this.$.nodeupdateajax.generateRequest()}}/**
   ...
   */},{key:"saveOutline",value:function saveOutline(e){console.log(e);// now let's work on the outline
...
if(values.cssVariable){values.hexCode=window.SimpleColorsUtilities.colors[values.cssVariable.replace("--simple-colors-default-theme-","").replace("-7","")][6]}this.set("updateManifestData.siteName",this.manifest.metadata.siteName);this.notifyPath("updateManifestData.siteName");this.set("updateManifestData.manifest",values);this.notifyPath("updateManifestData.manifest");this.set("updateManifestData.jwt",this.jwt);this.notifyPath("updateManifestData.jwt");if(this.saveManifestPath){this.$.manifestupdateajax.generateRequest()}}/**
   ...
   */},{key:"_bodyChanged",value:function _bodyChanged(e){window.HaxStore.instance.activeHaxBody.importContent(e.detail)}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_09bf72007f5511e9b1675b5e716153d2())}},{key:"properties",get:function get(){var _ref;return _ref={/**
