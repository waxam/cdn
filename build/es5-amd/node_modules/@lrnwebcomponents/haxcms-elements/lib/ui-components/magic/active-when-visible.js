define(["exports","../../../../../@polymer/polymer/polymer-element.js","../../core/haxcms-site-store.js","../../../../../@polymer/polymer/lib/utils/render-status.js"],function(_exports,_polymerElement,_haxcmsSiteStore,_renderStatus){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.ActiveWhenVisible=void 0;function _templateObject_c64965307f5411e9b1675b5e716153d2(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n        a {\n          height: 10px;\n          width: 10px;\n          float: left;\n          pointer-events: none;\n          background-color: transparent;\n        }\n      </style>\n      <div>\n        <a id=\"a\" href$=\"[[_a]]\" name$=\"#[[itemId]]\" aria-hidden></a>\n        <slot></slot>\n      </div>\n    "]);_templateObject_c64965307f5411e9b1675b5e716153d2=function _templateObject_c64965307f5411e9b1675b5e716153d2(){return data};return data}/**
 * `active-when-visible`
 * `Title of the site`
 *
 * @customElement
...
},{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_c64965307f5411e9b1675b5e716153d2())}/**
   * Props
