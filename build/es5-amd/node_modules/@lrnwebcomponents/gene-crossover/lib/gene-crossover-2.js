...
righttl.to([setonerighttwo],.1,babelHelpers.defineProperty({x:"-=10",display:"block"},"display","none")).to([setonerightthree],.3,babelHelpers.defineProperty({x:"-=10",display:"block"},"display","none")).to([setonerightfour],.3,{x:"-=10",display:"block"});this.tl=tl;this.lefttl=lefttl;this.righttl=righttl;this.animationReady=!0;this.tl.pause();this.lefttl.pause();this.righttl.pause()}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_eb6473007f5411e9b1675b5e716153d2())}},{key:"tag",get:function get(){return"gene-crossover-2"}},{key:"properties",get:function get(){return{tl:{type:Object,value:null},selected:{type:Boolean,value:!1},animationReady:{type:Boolean,value:!1}}}},{key:"observers",get:function get(){return["_selectedChanged(selected, animationReady)"]}}]);return GeneCrossover2}(_polymerElement.PolymerElement);_exports.GeneCrossover2=GeneCrossover2;window.customElements.define(GeneCrossover2.tag,GeneCrossover2)});