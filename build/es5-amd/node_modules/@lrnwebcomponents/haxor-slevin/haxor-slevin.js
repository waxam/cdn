define(["exports", "require", "../../lit-element/lit-element.js", "../haxcms-elements/lib/core/HAXCMSLitElementTheme.js", "../haxcms-elements/lib/core/haxcms-site-store.js", "../../mobx/lib/mobx.module.js", "../utils/utils.js"], function (_exports, _require, _litElement, _HAXCMSLitElementTheme, _haxcmsSiteStore, _mobxModule, _utils) {
  ...
  function _templateObject5_594dfbe0234511eaa816efb437265b94() {
    ...
    _templateObject5_594dfbe0234511eaa816efb437265b94 = function _templateObject5_594dfbe0234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject4_594dfbe0234511eaa816efb437265b94() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <simple-blog-card\n                    alt=\"", "\"\n                    color=\"", "\"\n                    .title=\"", "\"\n                    size=\"small\"\n                    .link=\"", "\"\n                    .image=\"", "\"\n                    .author=\"", "\"\n                    .timestamp=\"", "\"\n                    .readtime=\"", "\"\n                    .authorimage=\"", "\"\n                    .placeholder=\"", "\"\n                    .authorlink=\"", "\"\n                  >\n                    ", "\n                  </simple-blog-card>\n                "]);

    _templateObject4_594dfbe0234511eaa816efb437265b94 = function _templateObject4_594dfbe0234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject3_594dfbe0234511eaa816efb437265b94() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <simple-blog-card\n                    alt=\"", "\"\n                    color=\"", "\"\n                    .title=\"", "\"\n                    size=\"medium\"\n                    .link=\"", "\"\n                    .image=\"", "\"\n                    .author=\"", "\"\n                    .timestamp=\"", "\"\n                    .readtime=\"", "\"\n                    .authorimage=\"", "\"\n                    .placeholder=\"", "\"\n                    .authorlink=\"", "\"\n                  >\n                    ", "\n                  </simple-blog-card>\n                "]);

    _templateObject3_594dfbe0234511eaa816efb437265b94 = function _templateObject3_594dfbe0234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject2_594dfbe0234511eaa816efb437265b94() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <simple-blog-card\n                    alt=\"", "\"\n                    color=\"", "\"\n                    .title=\"", "\"\n                    size=\"large\"\n                    .link=\"", "\"\n                    .image=\"", "\"\n                    .author=\"", "\"\n                    .timestamp=\"", "\"\n                    .readtime=\"", "\"\n                    .authorimage=\"", "\"\n                    .placeholder=\"", "\"\n                    .authorlink=\"", "\"\n                  >\n                    ", "\n                  </simple-blog-card>\n                "]);

    _templateObject2_594dfbe0234511eaa816efb437265b94 = function _templateObject2_594dfbe0234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject_594dfbe0234511eaa816efb437265b94() {
    ...
    _templateObject_594dfbe0234511eaa816efb437265b94 = function _templateObject_594dfbe0234511eaa816efb437265b94() {
      return data;
    };
  ...
  function (_HAXCMSLitElementThem) {
    ...
    babelHelpers.createClass(HaxorSlevin, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_594dfbe0234511eaa816efb437265b94(), this._goBack, this.icon, this.title, this.activeTitle, this.image, this.siteModalClick, this.selectedPage, this.__mainPostsChanged, this.__mainPosts.map(function (post) {
          return (0, _litElement.html)(_templateObject2_594dfbe0234511eaa816efb437265b94(), post.metadata.fields && post.metadata.fields.images && post.metadata.fields.images[0] && post.metadata.fields.images[0].alt ? post.metadata.fields.images[0].alt : "", _this2.color, post.title, post.location, _this2._showImage(post.metadata.fields && post.metadata.fields.images && post.metadata.fields.images[0] && post.metadata.fields.images[0].alt ? post.metadata.fields.images[0].alt : false), _this2.author.name, post.metadata.created, post.metadata.readtime, _this2.author.image, _this2.image, _this2.author.socialLink, post.description);
        }), this.__extraPostsChanged, this.__extraPosts.map(function (post) {
          return (0, _litElement.html)(_templateObject3_594dfbe0234511eaa816efb437265b94(), post.metadata.fields && post.metadata.fields.images && post.metadata.fields.images[0] && post.metadata.fields.images[0].alt ? post.metadata.fields.images[0].alt : "", _this2.color, post.title, post.location, _this2._showImage(post.metadata.fields && post.metadata.fields.images && post.metadata.fields.images[0] && post.metadata.fields.images[0].alt ? post.metadata.fields.images[0].alt : false), _this2.author.name, post.metadata.created, post.metadata.readtime, _this2.author.image, _this2.image, _this2.author.socialLink, post.description);
          ...
          return (0, _litElement.html)(_templateObject4_594dfbe0234511eaa816efb437265b94(), post.metadata.fields && post.metadata.fields.images && post.metadata.fields.images[0] && post.metadata.fields.images[0].alt ? post.metadata.fields.images[0].alt : "", _this2.color, post.title, post.location, _this2._showImage(post.metadata.fields && post.metadata.fields.images && post.metadata.fields.images[0] && post.metadata.fields.images[0].alt ? post.metadata.fields.images[0].alt : false), _this2.author.name, post.metadata.created, post.metadata.readtime, _this2.author.image, _this2.image, _this2.author.socialLink, post.description);
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject5_594dfbe0234511eaa816efb437265b94())];
      }
    }, {
      key: "tag",
      get: function get() {
