define(["exports", "../../../lit-element/lit-element.js", "../../simple-colors/simple-colors.js", "../../../@polymer/iron-icons/iron-icons.js", "../../../@polymer/paper-icon-button/paper-icon-button.js", "../../../@polymer/paper-input/paper-input.js", "../../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _litElement, _simpleColors, _ironIcons, _paperIconButton, _paperInput, _customStyle) {
  ...
  function _templateObject2_6d6a73b0234511eaa816efb437265b94() {
    ...
    _templateObject2_6d6a73b0234511eaa816efb437265b94 = function _templateObject2_6d6a73b0234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject_6d6a73b0234511eaa816efb437265b94() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <custom-style>\n        <style>\n          paper-input {\n            --paper-input-container-shared-input-style: {\n              height: 40px;\n              padding: 0;\n              margin: 0;\n            }\n          }\n        </style>\n      </custom-style>\n      <paper-input\n        id=\"input\"\n        class=\"input\"\n        value=\"", "\"\n        @value-changed=\"", "\"\n        ?hidden=\"", "\"\n      ></paper-input>\n      <div class=\"input\" ?hidden=\"", "\">", "</div>\n      <div class=\"ops\" ?hidden=\"", "\">\n        <paper-icon-button\n          @click=\"", "\"\n          id=\"edit\"\n          icon=\"icons:create\"\n        ></paper-icon-button>\n        <paper-icon-button\n          @click=\"", "\"\n          id=\"add\"\n          icon=\"icons:add\"\n        ></paper-icon-button>\n        <paper-icon-button\n          @click=\"", "\"\n          id=\"duplicate\"\n          icon=\"icons:content-copy\"\n        ></paper-icon-button>\n        <paper-icon-button\n          @click=\"", "\"\n          id=\"delete\"\n          icon=\"icons:delete\"\n        ></paper-icon-button>\n      </div>\n    "]);

    _templateObject_6d6a73b0234511eaa816efb437265b94 = function _templateObject_6d6a73b0234511eaa816efb437265b94() {
      return data;
    };
  ...
  function (_SimpleColors) {
    ...
    babelHelpers.createClass(EditableListItem, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_6d6a73b0234511eaa816efb437265b94(), this.value, this.valueChanged, !this.editing, !this.editing, this.value, !this.editMode, this._editToggle, this._editToggle, this._editToggle, this._deleteModal);
      }
    }, {
      key: "valueChanged",
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(EditableListItem), "styles", this)), [(0, _litElement.css)(_templateObject2_6d6a73b0234511eaa816efb437265b94())]);
      }
    }]);
