define(["exports","../../@polymer/polymer/polymer-element.js","../../@polymer/paper-toast/paper-toast.js","../../@polymer/paper-button/paper-button.js","../../@polymer/polymer/lib/legacy/polymer.dom.js","../../@polymer/polymer/lib/utils/async.js"],function(_exports,_polymerElement,_paperToast,_paperButton,_polymerDom,async){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.SimpleToast=void 0;async=babelHelpers.interopRequireWildcard(async);function _templateObject_d9f62b407f5411e9b1675b5e716153d2(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        paper-toast {\n          @apply --simple-toast-toast;\n        }\n      </style>\n      <paper-toast\n        id=\"toast\"\n        text=\"[[text]]\"\n        duration$=\"[[duration]]\"\n        opened=\"{{opened}}\"\n        class$=\"[[classStyle]]\"\n      >\n        <slot></slot>\n        <paper-button hidden$=\"[[!closeButton]]\" on-click=\"hide\"\n          >[[closeText]]</paper-button\n        >\n      </paper-toast>\n    "]);_templateObject_d9f62b407f5411e9b1675b5e716153d2=function _templateObject_d9f62b407f5411e9b1675b5e716153d2(){return data};return data}// register globally so we can make sure there is only one
...
get:function get(){return(0,_polymerElement.html)(_templateObject_d9f62b407f5411e9b1675b5e716153d2())}// properties available to the custom element for data binding
