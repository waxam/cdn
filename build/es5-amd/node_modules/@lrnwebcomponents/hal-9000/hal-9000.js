define(["exports","meta","../../@polymer/polymer/polymer-element.js","../es-global-bridge/es-global-bridge.js","../../@polymer/polymer/lib/utils/resolve-url.js"],function(_exports,meta,_polymerElement,_esGlobalBridge,_resolveUrl){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.Hal9000=void 0;meta=babelHelpers.interopRequireWildcard(meta);function _templateObject_caf4ebe07f5411e9b1675b5e716153d2(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n        [hidden] {\n          display: none;\n        }\n      </style>\n      <slot></slot>\n    "]);_templateObject_caf4ebe07f5411e9b1675b5e716153d2=function _templateObject_caf4ebe07f5411e9b1675b5e716153d2(){return data};return data}/**
 * `hal-9000`
...
get:function get(){return(0,_polymerElement.html)(_templateObject_caf4ebe07f5411e9b1675b5e716153d2())}// properties available to the custom element for data binding
