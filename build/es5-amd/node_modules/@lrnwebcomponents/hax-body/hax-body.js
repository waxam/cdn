define(["exports", "require", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../utils/utils.js"], function (_exports, _require, _litElement, _simpleColors, _utils) {
  ...
  function _templateObject2_583d0110234511eaa816efb437265b94() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"bodycontainer\" class=\"ignore-activation\">\n        <slot id=\"body\"></slot>\n      </div>\n      <hax-text-context\n        id=\"textcontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-text-context>\n      <hax-ce-context\n        id=\"cecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-ce-context>\n      <hax-plate-context\n        id=\"platecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-plate-context>\n      <hax-input-mixer\n        id=\"haxinputmixer\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-input-mixer>\n    "]);

    _templateObject2_583d0110234511eaa816efb437265b94 = function _templateObject2_583d0110234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject_583d0110234511eaa816efb437265b94() {
    ...
    _templateObject_583d0110234511eaa816efb437265b94 = function _templateObject_583d0110234511eaa816efb437265b94() {
      return data;
    };
  ...
  function (_SimpleColors) {
    ...
    babelHelpers.createClass(HaxBody, null, [{
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HaxBody), "styles", this)), [(0, _litElement.css)(_templateObject_583d0110234511eaa816efb437265b94())]);
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(HaxBody, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_583d0110234511eaa816efb437265b94());
      }
      /**
      ...
      value: function _onKeyPress(e) {
        ...
        if (!this.openDrawer && this.editMode && this.shadowRoot.querySelector("#platecontextmenu").classList.contains("hax-active-hover") && this.activeNode && window.HaxStore.instance.isTextElement(this.activeNode)) {
          this.__dropActiveHover();
      ...
      value: function positionContextMenus(node, container) {
        if (node) {
          ...
          if (babelHelpers.typeof(props) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && !window.HaxStore.instance.isTextElement(node)) {
            ...
            this._positionContextMenu(this.shadowRoot.querySelector("#cecontextmenu"), node, -39, -39);
          } else {
            this._hideContextMenu(this.shadowRoot.querySelector("#cecontextmenu"));

            this._positionContextMenu(this.shadowRoot.querySelector("#textcontextmenu"), node, -39, -39);
          }
      ...
      value: function dropEvent(e) {
        ...
        if (!this.openDrawer && this.editMode) {
          ...
          if (target && typeof target.focus === "function") {
            setTimeout(function () {
              _this12.positionContextMenus(_this12.activeNode, _this12.activeContainerNode);
            }, 0);
          }
        }
      }
      ...
      value: function _activeNodeChanged(newValue, oldValue) {
        ...
        if (this.editMode && babelHelpers.typeof(newValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && newValue !== null) {
          ...
          if (window.HaxStore.instance.isTextElement(newValue) || window.HaxStore.instance.isGridPlateElement(newValue)) {
            ...
            clearTimeout(this.__positionContextTimer);
            this.__positionContextTimer = setTimeout(function () {
              if (newValue === _this13.activeNode) {
                _this13.positionContextMenus(newValue, newValue);
              }
            }, 10);
          } else {
            newValue.removeAttribute("contenteditable");
