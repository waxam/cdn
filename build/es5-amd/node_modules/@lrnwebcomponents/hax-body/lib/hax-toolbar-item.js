define(["exports", "../../../lit-element/lit-element.js", "../../simple-colors/lib/simple-colors-polymer.js", "../../../@polymer/paper-button/paper-button.js", "../../../@polymer/paper-tooltip/paper-tooltip.js", "../../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _litElement, _simpleColorsPolymer, _paperButton, _paperTooltip, _customStyle) {
  ...
  function _templateObject2_6f00f230234511eaa816efb437265b94() {
    ...
    _templateObject2_6f00f230234511eaa816efb437265b94 = function _templateObject2_6f00f230234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject_6f00f230234511eaa816efb437265b94() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <custom-style>\n        <style>\n          paper-tooltip {\n            --paper-tooltip: {\n              border-radius: 0;\n              font-size: 14px;\n            }\n          }\n        </style>\n      </custom-style>\n      <paper-button\n        .disabled=\"", "\"\n        id=\"btn\"\n        tabindex=\"0\"\n        .title=\"", "\"\n      >\n        <iron-icon\n          icon=\"", "\"\n          ?hidden=\"", "\"\n        ></iron-icon>\n        <span id=\"label\" ?hidden=\"", "\"\n          >", "</span\n        >\n        <slot></slot>\n      </paper-button>\n      <paper-tooltip\n        for=\"btn\"\n        ?hidden=\"", "\"\n        id=\"tooltip\"\n        offset=\"10\"\n        position=\"", "\"\n      >\n        ", "\n      </paper-tooltip>\n    "]);

    _templateObject_6f00f230234511eaa816efb437265b94 = function _templateObject_6f00f230234511eaa816efb437265b94() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(HaxToolbarItem, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_6f00f230234511eaa816efb437265b94(), this.disabled, this.tooltip, this.icon, this.icon == "" ? true : false, this.label == "" ? true : false, this.label, this.tooltip == "" ? true : false, this.tooltipDirection, this.tooltip);
      }
    }], [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_6f00f230234511eaa816efb437265b94())];
      }
    }, {
      key: "tag",
      get: function get() {
