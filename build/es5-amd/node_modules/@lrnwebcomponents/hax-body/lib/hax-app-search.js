define(["exports", "require", "../../../lit-element/lit-element.js", "../../simple-colors/simple-colors.js", "../../../@polymer/iron-ajax/iron-ajax.js", "../../utils/utils.js", "../../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _simpleColors, _ironAjax, _utils, _customStyle) {
  ...
  function _templateObject3_6e0ddfa0234511eaa816efb437265b94() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <hax-app-search-result\n              image=\"", "\"\n              title=\"", "\"\n              details=\"", "\"\n              .map=\"", "\"\n              type=\"", "\"\n            ></hax-app-search-result>\n          "]);

    _templateObject3_6e0ddfa0234511eaa816efb437265b94 = function _templateObject3_6e0ddfa0234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject2_6e0ddfa0234511eaa816efb437265b94() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <custom-style>\n        <style>\n          paper-card {\n            --paper-card-header: {\n              max-height: 160px;\n            }\n          }\n        </style>\n      </custom-style>\n      <iron-ajax\n        id=\"request\"\n        handle-as=\"json\"\n        @last-response-changed=\"", "\"\n        @loading-changed=\"", "\"\n        debounce-duration=\"200\"\n      ></iron-ajax>\n      <hax-app-search-inputs\n        id=\"searchinput\"\n        .label=\"", "\"\n        .schema=\"", "\"\n        @search-values-changed=\"", "\"\n      ></hax-app-search-inputs>\n      <hax-app-pagination\n        id=\"pagerbottom\"\n        .request-data=\"", "\"\n        .pagination=\"", "\"\n      ></hax-app-pagination>\n      <hexagon-loader\n        size=\"medium\"\n        item-count=\"4\"\n        ?loading=\"", "\"\n        aria-roledescription=\"Loading\"\n      ></hexagon-loader>\n      <div id=\"itemlist\">\n        ", "\n      </div>\n    "]);

    _templateObject2_6e0ddfa0234511eaa816efb437265b94 = function _templateObject2_6e0ddfa0234511eaa816efb437265b94() {
      return data;
    };
  ...
  function _templateObject_6e0ddfa0234511eaa816efb437265b94() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        paper-button.item-wrapper {\n          margin: 0;\n          padding: 0;\n        }\n        paper-card {\n          padding: 0;\n          margin: 8px;\n          width: 240px;\n          font-size: 12px;\n        }\n        @media screen and (min-width: 800px) {\n          paper-card {\n            font-size: 14px;\n          }\n        }\n        hexagon-loader {\n          display: none;\n          justify-content: center;\n          width: 100%;\n          z-index: 1000;\n          position: absolute;\n          --hexagon-color: var(--hax-color-bg-accent, #0085ba);\n        }\n        hexagon-loader[loading] {\n          display: block;\n          opacity: 0.8;\n        }\n        .card-content {\n          padding: 16px;\n        }\n        .card-content p {\n          padding: 0;\n          margin: 0;\n        }\n        #itemlist {\n          min-height: 172px;\n          border: 1px solid #222222;\n        }\n        hax-app-search-inputs {\n          min-height: 150px;\n          padding: 0 16px;\n        }\n        hax-app-pagination {\n          min-height: 32px;\n          font-size: 12.8px;\n          display: none;\n          justify-content: flex-end;\n          justify-content: center;\n        }\n      "]);

    _templateObject_6e0ddfa0234511eaa816efb437265b94 = function _templateObject_6e0ddfa0234511eaa816efb437265b94() {
      return data;
    };
  ...
  function (_winEventsElement) {
    ...
    babelHelpers.createClass(HaxAppSearch, null, [{
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HaxAppSearch), "styles", this)), [(0, _litElement.css)(_templateObject_6e0ddfa0234511eaa816efb437265b94())]);
      }
    }]);
    ...
    babelHelpers.createClass(HaxAppSearch, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_6e0ddfa0234511eaa816efb437265b94(), this.requestDataChanged, this._loadingChanged, this.label, this.searchSchema, this._searchValuesChanged, this.requestData, this.pagination, this.loading, this.media.map(function (resultData) {
          return (0, _litElement.html)(_templateObject3_6e0ddfa0234511eaa816efb437265b94(), resultData.image, resultData.title, resultData.details, resultData.map, resultData.type);
        }));
      }
    }, {
