define(["exports","require","../../../@polymer/polymer/polymer-element.js","../../../@polymer/iron-ajax/iron-ajax.js","../../simple-colors/simple-colors.js","../../../@polymer/iron-list/iron-list.js"],function(_exports,_require,_polymerElement,_ironAjax,_simpleColors,_ironList){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.HaxAppSearch=void 0;_require=babelHelpers.interopRequireWildcard(_require);function _templateObject_ee5726207f5411e9b1675b5e716153d2(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n        paper-button.item-wrapper {\n          margin: 0;\n          padding: 0;\n        }\n        paper-card {\n          padding: 0;\n          margin: 8px;\n          width: 240px;\n          font-size: 12px;\n          --paper-card-header: {\n            max-height: 160px;\n          }\n        }\n        @media screen and (min-width: 800px) {\n          paper-card {\n            font-size: 14px;\n          }\n        }\n        hexagon-loader {\n          height: 100%;\n          justify-content: center;\n          margin: 0 auto -200px;\n          z-index: 1000;\n          position: relative;\n          transition: 0.3s linear opacity, 0.3s linear visibility;\n          width: calc(100% - 32px);\n          opacity: 0;\n          visibility: visible;\n        }\n        hexagon-loader[loading] {\n          opacity: 1;\n        }\n        .card-content {\n          padding: 16px;\n        }\n        .card-content p {\n          padding: 0;\n          margin: 0;\n        }\n        #itemlist {\n          min-height: 172px;\n          border: 1px solid #222222;\n        }\n        hax-app-search-inputs {\n          min-height: 150px;\n          padding: 0 16px;\n        }\n        hax-app-pagination {\n          min-height: 32px;\n          font-size: 12.8px;\n          display: none;\n          justify-content: flex-end;\n          justify-content: center;\n        }\n      </style>\n\n      <iron-ajax\n        auto=\"[[auto]]\"\n        id=\"request\"\n        method=\"[[method]]\"\n        url=\"[[requestEndPoint]]\"\n        handle-as=\"json\"\n        headers=\"[[headers]]\"\n        params=\"[[requestParams]]\"\n        last-response=\"{{requestData}}\"\n        hidden=\"\"\n        loading=\"{{loading}}\"\n        debounce-duration=\"300\"\n      ></iron-ajax>\n      <hax-app-search-inputs\n        id=\"searchinput\"\n        label=\"[[label]]\"\n        schema=\"{{searchSchema}}\"\n        values=\"{{searchValues}}\"\n      ></hax-app-search-inputs>\n      <hax-app-pagination\n        id=\"pagerbottom\"\n        request-data=\"[[requestData]]\"\n        pagination=\"[[pagination]]\"\n      ></hax-app-pagination>\n      <hexagon-loader\n        size=\"small\"\n        loading$=\"[[loading]]\"\n        color=\"#0085ba\"\n        aria-roledescription=\"Loading\"\n      ></hexagon-loader>\n      <iron-list\n        grid\n        id=\"itemlist\"\n        items=\"[[media]]\"\n        as=\"resultData\"\n        hidden$=\"[[loading]]\"\n      >\n        <template>\n          <hax-app-search-result\n            result-data=\"[[resultData]]\"\n          ></hax-app-search-result>\n        </template>\n      </iron-list>\n    "]);_templateObject_ee5726207f5411e9b1675b5e716153d2=function _templateObject_ee5726207f5411e9b1675b5e716153d2(){return data};return data}/**
 * `hax-app-search`
