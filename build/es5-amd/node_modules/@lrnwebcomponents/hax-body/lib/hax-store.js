define(["exports","meta","require","../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/utils/render-status.js","../../../@polymer/polymer/lib/legacy/polymer.dom.js","../../../@polymer/polymer/lib/utils/resolve-url.js","../../../@polymer/polymer/lib/utils/settings.js","./shadows-safari.js","./haxutils.js","../../../@polymer/iron-ajax/iron-ajax.js","../../simple-toast/simple-toast.js","../../media-behaviors/media-behaviors.js","../../hax-body-behaviors/hax-body-behaviors.js","../../code-sample/code-sample.js"],function(_exports,meta,_require,_polymerElement,_renderStatus,_polymerDom,_resolveUrl,_settings,_shadowsSafari,_haxutils,_ironAjax,_simpleToast,_mediaBehaviors,_haxBodyBehaviors,_codeSample){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.HaxStore=void 0;meta=babelHelpers.interopRequireWildcard(meta);_require=babelHelpers.interopRequireWildcard(_require);function _templateObject_f67390a07f5411e9b1675b5e716153d2(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: none;\n        }\n      </style>\n      <slot></slot>\n      <iron-ajax\n        id=\"appstore\"\n        url=\"[[appStore.url]]\"\n        params=\"[[appStore.params]]\"\n        method=\"GET\"\n        content-type=\"application/json\"\n        handle-as=\"json\"\n        last-response=\"{{__appStoreData}}\"\n      ></iron-ajax>\n      <hal-9000 id=\"hal\" debug=\"debug\" commands=\"[[voiceCommands]]\"></hal-9000>\n    "]);_templateObject_f67390a07f5411e9b1675b5e716153d2=function _templateObject_f67390a07f5411e9b1675b5e716153d2(){return data};return data}var HaxStore=/*#__PURE__*/function(_HAXElement){babelHelpers.inherits(HaxStore,_HAXElement);babelHelpers.createClass(HaxStore,[{key:"_storageDataChanged",/**
...
var sel=window.HaxStore.getSelection(),range;if(range=window.HaxStore.getRange()){range.deleteContents();range.insertNode(document.createTextNode(text))}}}/**
   ...
   */}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_f67390a07f5411e9b1675b5e716153d2())}},{key:"tag",get:function get(){return"hax-store"}/**
...
document.body.addEventListener("hax-register-export",_this._haxStoreRegisterExport.bind(babelHelpers.assertThisInitialized(_this)));// notice content insert and help it along to the body
